...
class App extends Component {
      ...
      content: [
        {
          ...
          url: 'https://www.possible.com/en',
          description: 'Design lead on a workstream looking at applying augmented reality to an online retail experience. Helping set design process and culture for account, bringing product design thinking to digital advertising studio.'
        },
        {
          type:'project',
          typeAt: 'side',
          ...
          subTitle:'Creator',
          date: 'Jan 2017',
          url: 'https://closertomidnight.world',
          description: `The stark reality of the risks we're facing going in to the new year.`
        },
        {
          type:'writing',
        ...
        },
        {
          ...
          date:'Dec 2015',
          video: 'https://vimeo.com/163799737',
        ...
        },
        {
          ...
          video: 'https://vimeo.com/45281305',
  ...
  getFilters() {
    let filters = this.state.filters.map((d,i)=>{
      return (
        <div className={ `App-filters-filter is-${ d.name }` }>
  ...
  getAppModules() {
    let modules = this.state.content.map((d,i)=>{
      let video;
      if (d.video) {
